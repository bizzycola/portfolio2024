            ...
            <section className="text-left mt-10 lg:p-0 p-5" style={{ "maxWidth": "960px" }}>
                ...
                <div className="mb-10">
                    ...
                    <div className="flex flex-row items-center flex-wrap gap-2">
                        <div className="py-1 px-4 rounded-md bg-gray-200">HTML</div>
                        <div className="py-1 px-4 rounded-md bg-gray-200">CSS</div>
                        <div className="py-1 px-4 rounded-md bg-gray-200">TypeScript</div>
                        <div className="py-1 px-4 rounded-md bg-gray-200">React</div>
                        <div className="py-1 px-4 rounded-md bg-gray-200">NestJS</div>
                    </div>
                </div>
            </section>
            <PageFooter />
